...
class MyOrderDetailsActivity : BaseActivity() {
    ...
    private fun setupUI(orderDetails: Order) {
        ...
        val cartListAdapter =
            CartItemsListAdapter(this@MyOrderDetailsActivity, orderDetails.items, null, false)
        ...
        "${orderDetails.address.address}, ${orderDetails.address.zip_code}".also { tv_my_order_details_address.text = it }
        tv_my_order_details_additional_note.text = orderDetails.address.additional_note

        if(orderDetails.address.type == Constants.OTHER && orderDetails.address.other_details.isNotEmpty()){
